...
import { Column, CopyToClipboardIcon, DeepLLogo, TooltipContainer, Translation } from "./style";
...
const Tooltip = ({ bottom, left, selectedText }: ITooltipProps): JSX.Element => {
  ...
  return (
    <TooltipContainer bottom={bottom} left={left}>
      {!shouldTranslate ? <DeepLLogo src={deepl_logo} alt="deepl_logos" onMouseDown={onClick} /> :
        <>
